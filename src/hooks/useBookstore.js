  ...
  useEffect(() => {
    setTimeout(() => {
      setBooks([
        ...
        { id: '5', titulo: 'El guardián entre el centeno', imagen: 'https://www.alianzaeditorial.es/imagenes/libros/grande/9788491049418-el-guardian-entre-el-centeno.jpg', sinopsis: 'La historia de un adolescente rebelde.', genero: 'Ficción', popularidad: 4.1 },
        { id: '6', titulo: 'Moby-Dick', imagen: 'https://www.mrbooks.com/mrbooks/portadas/9788483087565.webp', sinopsis: 'La caza de una ballena gigante.', genero: 'Aventura', popularidad: 3.6 },
      ]);
    }, 2500);
  }, []);
