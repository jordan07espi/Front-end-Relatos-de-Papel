  ...
  useEffect(() => {
    setTimeout(() => {
      setBooks([
        ...
        { id: '6', titulo: 'El guardián entre el centeno', imagen: 'https://www.alianzaeditorial.es/imagenes/libros/grande/9788491049418-el-guardian-entre-el-centeno.jpg', sinopsis: 'La historia de un adolescente rebelde.', genero: 'Ficción', popularidad: 4.1, precio: 11.99 }
      ]);
    }, 2500);
  }, []);
